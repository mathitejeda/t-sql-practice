Create Database ModeloParcial1
go
Use ModeloParcial1
go
...
Values (1, '1111', '2020/8/5', 250000, 5, 1)
Insert into Creditos(IDBanco, DNI, Fecha, Importe, Plazo, Cancelado)
Values (1, '1111', '2020/12/3', 50000, 3, 0)
Insert into Creditos(IDBanco, DNI, Fecha, Importe, Plazo, Cancelado)
Values (1, '1111', '2021/1/5', 25000, 5, 0)
Insert into Creditos(IDBanco, DNI, Fecha, Importe, Plazo, Cancelado)
Values (1, '2222', '2021/1/25', 225000, 15, 0)
Insert into Creditos(IDBanco, DNI, Fecha, Importe, Plazo, Cancelado)
Values (1, '3333', '2021/1/5', 10000, 10, 0)